...
app.use('/cinema', require('../src/infrastructure/http/router/cinema.router'));
app.use('/concert', require('../src/infrastructure/http/router/concert.router'));
app.use('/transport', require('../src/infrastructure/http/router/transport.router'));
app.use('/events', require('../src/infrastructure/http/router/events.router'));
app.use('/products', require('../src/infrastructure/http/router/products.router'));
app.use('/transactions', require('../src/infrastructure/http/router/transactions.router'));
app.use('/reservations', require('../src/infrastructure/http/router/reservations.router'));
app.use('/genero', require('../src/infrastructure/http/router/genre.router'));
app.use('/classification', require('../src/infrastructure/http/router/classifications.router'));
